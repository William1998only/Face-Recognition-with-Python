...
class Eigenfaces(object):    
    ...
    def evaluate_celebrities(self, celebrity_dir='.'):
        ...
        #for i in db.db.dosen_login(kode_gambar):
            ...
            #NIK = i[0]
        #print(NIK)
        if NIK: #Mengecek apakah benar wajah dosen
            print(NIK) #menampilkan NIK Dosen
            #print(NIK)
            ...
            if result:
                ...
                if Pengecekan:
                    ...
                    Halaman_Kedua.LoginWindow(result, NIK[0], Hari, Jam_Login[0], 0, 0)
                else:
        ...
        if(entryString == 'Dosen'):
            while True:
                ...
                if key == ord('s'): 
                    ...
                    efaces.evaluate_celebrities(str('wajah_presensi'))
                    break
